...
keys = [
    ...
    # Media keys
    Key([], "Print", lazy.spawn("sh /home/yeamin/.local/bin/screenshot.sh")),
...
layout_theme = {
    ...
    "margin": 8,
    "margin_on_single": 6,
    "border_focus": nordic['cyan'],
    "border_normal": nordic['gray']
}
        ...
        top=bar.Bar(
            [
                ...
                widget.GroupBox(
                    ...
                    block_highlight_text_color=nordic['bg'],
                    borderwidth=1,
                    highlight_color = nordic['cyan'],
                    background = nordic['bg'],
                    padding_x = 6,
                    center_aligned = True
                ),
